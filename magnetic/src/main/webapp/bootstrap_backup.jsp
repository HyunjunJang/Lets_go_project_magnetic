...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#!">A타입 게시판</a></li>
                        <li class="nav-item"><a class="nav-link" href="#!">B타입 게시판</a></li>
                        <li class="nav-item"><a class="nav-link" href="#!">C타입 게시판</a></li>
                        <li class="nav-item"><a class="nav-link" href="#!">D타입 게시판</a></li>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Your Magnetic 2023</p></div>
        </footer>
        <!-- Bootstrap core JS-->
